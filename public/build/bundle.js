...
;(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    factory(interopDefault(require$$2))
  } else {
    // Browser globals:
...
;(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    factory(interopDefault(require$$2), interopDefault(require$$0))
  } else {
    // Browser globals:
    factory(window.loadImage)
  }
...
;(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    factory(interopDefault(require$$2), interopDefault(require$$0$1))
  } else {
    // Browser globals:
    factory(window.loadImage)
  }
...
var loadImageIptc$1 = interopDefault(loadImageIptc);


var require$$0$2 = Object.freeze({
  default: loadImageIptc$1
});
...
;(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    factory(interopDefault(require$$2), interopDefault(require$$0$2))
  } else {
    // Browser globals:
    factory(window.loadImage)
  }
...
interopDefault(loadImageIptcMap);
...
;(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      ...
      interopDefault(require$$1),
      interopDefault(require$$0)
    )
  } else {
    // Browser globals:
    factory(window.loadImage)
...
module.exports = interopDefault(require$$2)
});
